...
Donate link: http://brechtryckaert.com/donate
Tags: password, protected, post, session, cookie
...
= 1.0.1 =
* Altered the plugin code. Thanks to the suggestions of pjherrel. Also updated for WP 4.6.
